...
function setup_testing_input_output {
  ...
  cp -r ${GRADER_ROOT}/tests/${test_folder}/input/log.csv ${TEST_OUTPUT_PATH}/input/log.csv
  cp -r ${GRADER_ROOT}/tests/${test_folder}/input/inactivity_period.txt ${TEST_OUTPUT_PATH}/input/inactivity_period.txt
  cp -r ${GRADER_ROOT}/tests/${test_folder}/output/sessionization.txt ${TEST_OUTPUT_PATH}/output/sessionization.txt
}
